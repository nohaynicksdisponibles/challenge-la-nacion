            ...
            <div className="lay">
                <section className="row footer-header">
                    <section className="col-desksm-4 col-desk-6 footer-header__logo">
                        <a href="https://www.lanacion.com.ar/" className="">
                            ...
                            <img className="logo-la-nacion-footer" src={lanacionLogo} alt="La Nacion"/>
                        </a>
                    </section>
                    <section className="col-12 col-desksm-4 col-desk-3 footer-header__redes">
                        {/*
                            <a href="https://www.facebook.com/lanacion" target="_blank"><i className="icon-facebook"></i></a>
                            <a href="https://twitter.com/LANACION" target="_blank"><i className="icon-twitter"></i></a>
                            <a href="https://www.instagram.com/lanacioncom/" target="_blank"><i className="icon-instagram"></i></a>
                            <a href="http://servicios.lanacion.com.ar/herramientas/rss/ayuda" target="_blank"><i className="icon-rss"></i></a>
                        */}
                        <img alt="facebook" src={facebook} className="facebook"/>
                        <img alt="twitter" src={twitter} className="twitter"/>
                        <img alt="instagram" src={insta} className="insta"/>
                        <img alt="rss" src={rss} className="rss"/>
                    </section>
                    <section className="col-12 col-desksm-4 col-desk-3 footer-header__app">
                        <a href="https://play.google.com/store/apps/details?id=app.lanacion.activity&hl=es_419" target="_blank" className="app_play">
                            ...
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <g fill-rule="nonzero">
                                    ...
                                    <path fill="url(#a)" d="M.64.41C.42.647.292 1.012.292 1.476v16.82c0 .472.128.837.346 1.065l.053.053L10.028 10v-.228L.692.357.64.411z" transform="translate(17.378 7.864)"/>
                                    <path fill="url(#b)" d="M13.14 13.14L10.028 10V9.77l3.112-3.14.068.038 3.684 2.114c1.055.6 1.055 1.589 0 2.197l-3.684 2.114-.068.046z" transform="translate(17.378 7.864)"/>
                                    <path fill="url(#c)" d="M13.208 13.094l-3.18-3.209L.639 19.36c.347.373.92.418 1.568.046l11-6.312" transform="translate(17.378 7.864)"/>
                                    <path fill="url(#d)" d="M13.208 6.676L2.199.365C1.551-.008.98.038.632.411l9.396 9.474 3.18-3.209z" transform="translate(17.378 7.864)"/>
                                    <g fill="#000">
                                        <path d="M30.517 20.89l-10.94 6.273c-.61.35-1.16.327-1.507.008l-.053.053.053.053c.354.32.897.342 1.507-.008l11.008-6.31-.068-.07z" opacity=".2"/>
                                        <path d="M18.017 27.117c-.218-.235-.346-.6-.346-1.064v.114c0 .471.128.836.346 1.064l.053-.053-.053-.06z" opacity=".12"/>
                                    </g>
                                    <path fill="#000" d="M34.27 18.738l-3.76 2.152.068.068 3.684-2.114c.528-.304.791-.7.791-1.095-.037.358-.301.715-.783.989z" opacity=".12"/>
                                    <path fill="#FFF" d="M19.577 8.335l14.693 8.426c.475.273.746.623.791.988 0-.395-.264-.798-.791-1.095L19.577 8.23c-1.055-.6-1.914-.099-1.914 1.118v.114c0-1.224.867-1.726 1.914-1.126z" opacity=".25"/>
                        ...
                        <a href="https://apps.apple.com/ar/app/la-nacion/id410689702" target="_blank" className="app_ios">
                            <svg xmlns="http://www.w3.org/2000/svg" width="120" height="35" viewBox="0 0 120 35">
                                <g fill="none" fill-rule="evenodd">
                                    <rect width="119.862" height="35" fill="#5A5A5A" rx="3"/>
                ...
                <section className="row footer-sitio">
                    ...
                    <section className="col-desksm-3 col-deskxl-4 footer-sitio__captcha">
                        <p>Protegido por re CAPTCHA: <a href="https://policies.google.com/terms?hl=es-419" target="_blank" className="condition">Condiciones</a> <a href="https://policies.google.com/privacy?hl=es-419" target="_blank" className="private">Privacidad</a></p> 
                    </section>
                </section>
                <section className="row footer-copyright">
                    <section className="col-desksm-6 col-desk-6 footer-copyright__fiscal">
                        <p><img src="https://static.glanacion.com/v2/ln/img/gda.jpg" alt="gda" className="img_gda" /> Miembro de GDA. Grupo de Diarios América <a href="https://serviciosweb.afip.gob.ar/clavefiscal/qr/publicInfoD.aspx" target="_blank"><img src="https://static.glanacion.com/v2/ln/img/data.jpg" alt="Data fiscal" className="img_data-fiscal" /></a></p>
